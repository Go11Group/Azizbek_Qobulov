...
type WeatherServiceClient interface {
	...
	ReportWeatherCondition(ctx context.Context, in *WeatherConditionRequest, opts ...grpc.CallOption) (*WeatherConditionResponse, error)
}
...
func (c *weatherServiceClient) ReportWeatherCondition(ctx context.Context, in *WeatherConditionRequest, opts ...grpc.CallOption) (*WeatherConditionResponse, error) {
...
type WeatherServiceServer interface {
	...
	ReportWeatherCondition(context.Context, *WeatherConditionRequest) (*WeatherConditionResponse, error)
...
func (UnimplementedWeatherServiceServer) ReportWeatherCondition(context.Context, *WeatherConditionRequest) (*WeatherConditionResponse, error) {
...
func _WeatherService_ReportWeatherCondition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WeatherConditionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WeatherServiceServer).ReportWeatherCondition(ctx, req.(*WeatherConditionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
